...
"[project]/app/expense-allocation/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ExpenseAllocationPage() {
    ...
    const canEdit = currentUserRole ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canEditPage"])(currentUserRole, 'expenseAllocation') : false;
    // Add new expense row
    const addExpenseRow = ()=>{
        const newRow = {
    ...
    const filteredExpenseRows = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>{
        ...
        if (descriptionFilter.trim()) {
            filtered = filtered.filter((row)=>row.description.toLowerCase().includes(descriptionFilter.toLowerCase().trim()));
        }
        return filtered;
    }, [
        expenseRows,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        expenseRows.forEach((row)=>{
            if (row.entity && row.amount > 0) {
                ...
                if (currentProjectAmounts !== newProjectAmountsStr) {
                    setExpenseRows(expenseRows.map((r)=>r.id === row.id ? {
                            ...r,
        ...
        entityProjectAllocations,
        expenseRows.map((r)=>`${r.entity}-${r.amount}`).join(','),
        uniqueProjects
    ]);
    if (!isClient) {
        return null;
...
//# sourceMappingURL=_fae3e5fd._.js.map